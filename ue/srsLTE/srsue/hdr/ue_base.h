...
public:
  ...
  // UE PDCP control interface
  virtual void set_reorder_timeout(uint32_t timeout) = 0;
  virtual void set_reorder_window(uint32_t window) = 0;
  virtual void set_report_period(uint32_t period) = 0;
  virtual void toggle_reorder(bool enable) = 0;
  virtual void toggle_report(bool enable) = 0;
  virtual void toggle_lwa(bool enable) = 0;
  virtual void toggle_elwa(bool enable) = 0;
  virtual void toggle_discard(bool enable) = 0;
  virtual void toggle_duplicate(bool enable) = 0;
