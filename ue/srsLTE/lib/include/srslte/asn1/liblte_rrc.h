...
typedef enum{
	...
	LIBLTE_RRC_PDCP_SN_SIZE_15_BITS,
	LIBLTE_RRC_PDCP_SN_SIZE_18_BITS,
    LIBLTE_RRC_PDCP_SN_SIZE_N_ITEMS,
}LIBLTE_RRC_PDCP_SN_SIZE_ENUM;
static const char liblte_rrc_pdcp_sn_size_text[LIBLTE_RRC_PDCP_SN_SIZE_N_ITEMS][20] = {"7-bits", "12-bits", "15-bits", "18-bits"};

static const int8 liblte_rrc_pdcp_sn_size_num[LIBLTE_RRC_PDCP_SN_SIZE_N_ITEMS] = {7, 12, 15, 18};
